...
# User management API
- Register new user: 127.0.0.1:8000/api/user/create
- Generate access token: 127.0.0.1:8000/api/user/token
- Edit user data (pass "Token 6716821995f528c059407b0e266039efbcb7d053" in HTTP
  request "Authorization" header - for testing in a browser use Modify Header
  extension): 127.0.0.1:8000/api/user/me
